...
const collections = {
  ...
  model: {
    number:'02', label:'MODEL PLAYERS AND GAMES', count:109, title:'What happens<br>after the next move?',
    description:'World models learn dynamics for planning, policy training, or direct interaction; fidelity also requires separating visual quality, mechanics, and persistent state. Player models predict human choices and behavior.',
    topics:['Learned simulation','Mechanics & state','Player behavior'],
...
const roleAtlas = {
  ...
  model: {
    number:'02', label:'MODEL PLAYERS AND GAMES', title:'AI that Models Players and Games', image:'sec3.webp', width:2400, height:767,
    alt:'Research directions for AI that models players and games, including player behavior, learned simulation, world state, and long-horizon interaction',
    caption:'Research directions for modeling players and games: player behavior modeling; planning, training, and simulation; world-state representation; and long-horizon interaction.',
    description:'AI predicts game dynamics, state, trajectories, or player behavior. A model can look convincing while missing a rule or forgetting state; its consumer determines which failure matters.',
  ...
  design: {
    ...
    description:'AI proposes levels, rules, mechanics, story structures, or assets. For an asset to become game content, appearance must connect to usable geometry, animation, or engine placement.',
    ...
    citations:[['MarioGPT','https://arxiv.org/abs/2302.05981'],['CubePart','https://arxiv.org/abs/2605.28763'],['DreamGarden','https://arxiv.org/abs/2410.01791']],
  },
  build: {
  ...
  runtime: {
    ...
    description:'AI changes a live experience through dialogue, speech, quests, content, rules, or personalization. Spoken interaction adds recognition, voice synthesis, and turn-taking to timing and state agreement.',
    ...
    citations:[['NarrativeGenie','https://doi.org/10.1609/aiide.v20i1.31868'],['The Interview','https://arxiv.org/html/2510.25820v1'],['IF:CARGO','https://arxiv.org/abs/2608.12195'],['1001 Nights','https://www.1001nights.ai/']],
  },
  test: {
