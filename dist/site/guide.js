...
const collections = {
  play: {
    number:'01', label:'PLAY AND ACT', count:104, title:'Learning to act.<br>Learning to cooperate.',
  ...
  model: {
    number:'02', label:'MODEL GAMES AND PLAYERS', count:105, title:'What happens<br>after the next move?',
  ...
  design: {
    number:'03', label:'DESIGN', count:47, title:'Imagine the rules.<br>Shape the possibility.',
