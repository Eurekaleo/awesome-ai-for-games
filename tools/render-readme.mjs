...
const lines = [
  ...
  `The living index currently combines **${sourceCounts.manuscript} manuscript references** with **${sourceCounts.livingAdditions} additional public works not in the manuscript**.`,
  '',
