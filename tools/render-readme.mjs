...
const lines = [
  ...
  '</p>',
  '',
  `**${sourceCounts.manuscript} survey references + ${sourceCounts.livingAdditions} living additions.** [Explore the visual survey map](https://eurekaleo.github.io/awesome-ai-for-games/#map) · [Search all papers](https://eurekaleo.github.io/awesome-ai-for-games/#papers) · [Suggest a paper](https://github.com/Eurekaleo/awesome-ai-for-games/issues/new/choose)`,
  '',
  '## Reading the index',
  '',
